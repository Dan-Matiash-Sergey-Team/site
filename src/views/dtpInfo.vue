      ...
      <div class="box  is-shadowless">
        ...
        <div class="tile is-ancestor">
          <div class="tile is-vertical">
            ...
            <div :key="b" v-for="b in this.dtpData.data['infoDtp']['ts_info']" style="margin-top: 10px">
              <div class="tile">
                <div class="box has-text-left">
                      ...
                      <div class="box is-shadowless">
                        ...
                        <div class="level-left">
                          <div class="is-one-fifth">
                            <div :key="d" v-for="d in c['NPDD']"><i class="fa fa-exclamation"></i> {{ d }}</div>
                          </div>
                        </div>
                        <div class="level-left">
                          <div class="is-one-fifth">
            ...
            <div :key="d" v-for="d in this.dtpData.data['infoDtp']['uchInfo']" style="margin-top: 10px">
              <div class="tile">
                <div class="box has-text-left">
                  <div class="level-left">
                    <div class="level-item is-one-fifth">
                  ...
                  <div class="tile is-child box is-shadowless">
                    <div class="level-left">
                      <div class="is-one-fifth">
                        <div :key="b" v-for="b in d['NPDD']"><i class="fa fa-exclamation"></i> {{ b }}</div>
                      </div>
                    </div>
                    <div class="level-left">
                      <div class="is-one-fifth">
                        <p><i class="fa fa-heartbeat"></i> {{ d['S_T'] }}</p> <!--тут тоже умпалумпа -->
                      </div>
                    </div>
                  </div>
                </div>

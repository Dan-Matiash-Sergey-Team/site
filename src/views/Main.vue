            ...
            <transition name="curtain">
              <div v-if="show">
                <div class="container">
                  ...
                  <button :disabled="heatmapMode" @click="heatmapMode?()=>{}:districtMode = !districtMode" style="margin-top: 20px">Статистика по
                    районам
                  </button>
                  <button :disabled="districtMode" @click="districtMode?()=>{}:heatmapMode = !heatmapMode" style="margin-top: 20px">Тепловая
                    карта
                  </button>
                </div>
              </div>
